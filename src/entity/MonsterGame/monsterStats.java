...
//---------------Boss------------------
    ...
    static{
        bossStats.put("PV", 250);
        bossStats.put("AttackSpeed", 10);

        bossStats.put("FireResistance", 10);
        bossStats.put("PhysicResistance", 10);
        bossStats.put("MagicResistance", 10);

        bossStats.put("FireDamage", 10);
        bossStats.put("PhysicDamage", 10);
        bossStats.put("MagicDamage", 10);
    }
